...
class ReportService {
  ...
  async generatePDFReport(date) {
      try {
        ...
        doc.fontSize(16).text('Machine Summary', { underline: true });
        doc.moveDown(0.5);
        doc.fontSize(10);
        ...
        doc.fontSize(16).text('Worker Summary', { underline: true });
        doc.moveDown(0.5);
        doc.fontSize(10);
        ...
        doc.addPage();
        doc.fontSize(16).text('Job Type Summary', { underline: true });
        doc.moveDown(0.5);
        doc.fontSize(10);
